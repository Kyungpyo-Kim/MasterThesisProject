...
from transform_nets import input_transform_net, feature_transform_net, feature_transform_net32
...
def get_model(point_cloud, is_training, bn_decay=None):
    ...
    with tf.variable_scope('transform_net2') as sc:
        transform = feature_transform_net32(net, is_training, bn_decay, K=32)
